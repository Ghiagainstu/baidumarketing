#!/usr/bin/env python3
"""
fix_blog_ko_final.py — 最终修复韩语博客详情页
...
def fix_file(filepath):
    ...
    # ========== 1. 替换导航 ==========
    # 匹配 <nav ... </nav> + <div class="nav-overlay"...>
    nav_pattern = r'<nav\s+class="nav"[^>]*>.*?</nav>\s*<div\s+class="nav-overlay"[^>]*></div>'
    ...
    content = re.sub(r'>\s*(\d+) min\s*<', r'>\1분 읽기<', content)
