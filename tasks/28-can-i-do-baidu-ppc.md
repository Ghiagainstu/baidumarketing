...
## 文件信息
- **源文件**: `blog/can-i-do-baidu-ppc.html`
- **输出文件**: `ja/blog/can-i-do-baidu-ppc.html`
- **在线 URL**: `https://baidumarketing.com/ja/blog/can-i-do-baidu-ppc`

## 操作步骤

### 1. 读取源文件
打开 `blog/can-i-do-baidu-ppc.html`，读取全部内容。

### 2. 进行翻译 + 输出到 `ja/blog/can-i-do-baidu-ppc.html`
...
| canonical URL | `https://baidumarketing.com/ja/blog/can-i-do-baidu-ppc` |
...
### 5. 验证清单
完成后逐项确认：
- [ ] 文件输出到 `ja/blog/can-i-do-baidu-ppc.html`
- [ ] `<html lang="ja">`
- [ ] canonical: `https://baidumarketing.com/ja/blog/can-i-do-baidu-ppc`
