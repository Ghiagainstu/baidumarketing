...
## 文件信息
- **源文件**: `blog/how-much-does-baidu-ppc-cost.html`
- **输出文件**: `ja/blog/how-much-does-baidu-ppc-cost.html`
- **在线 URL**: `https://baidumarketing.com/ja/blog/how-much-does-baidu-ppc-cost`

## 操作步骤

### 1. 读取源文件
打开 `blog/how-much-does-baidu-ppc-cost.html`，读取全部内容。

### 2. 进行翻译 + 输出到 `ja/blog/how-much-does-baidu-ppc-cost.html`
...
| canonical URL | `https://baidumarketing.com/ja/blog/how-much-does-baidu-ppc-cost` |
...
### 5. 验证清单
完成后逐项确认：
- [ ] 文件输出到 `ja/blog/how-much-does-baidu-ppc-cost.html`
- [ ] `<html lang="ja">`
- [ ] canonical: `https://baidumarketing.com/ja/blog/how-much-does-baidu-ppc-cost`
