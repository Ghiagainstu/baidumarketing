...
## 文件信息
- **源文件**: `blog/keyword-research-baidu.html`
- **输出文件**: `ja/blog/keyword-research-baidu.html`
- **在线 URL**: `https://baidumarketing.com/ja/blog/keyword-research-baidu`

## 操作步骤

### 1. 读取源文件
打开 `blog/keyword-research-baidu.html`，读取全部内容。

### 2. 进行翻译 + 输出到 `ja/blog/keyword-research-baidu.html`
...
| canonical URL | `https://baidumarketing.com/ja/blog/keyword-research-baidu` |
...
### 5. 验证清单
完成后逐项确认：
- [ ] 文件输出到 `ja/blog/keyword-research-baidu.html`
- [ ] `<html lang="ja">`
- [ ] canonical: `https://baidumarketing.com/ja/blog/keyword-research-baidu`
