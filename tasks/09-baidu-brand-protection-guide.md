...
## 文件信息
- **源文件**: `blog/baidu-brand-protection-guide.html`
- **输出文件**: `ja/blog/baidu-brand-protection-guide.html`
- **在线 URL**: `https://baidumarketing.com/ja/blog/baidu-brand-protection-guide`

## 操作步骤

### 1. 读取源文件
打开 `blog/baidu-brand-protection-guide.html`，读取全部内容。

### 2. 进行翻译 + 输出到 `ja/blog/baidu-brand-protection-guide.html`
...
| canonical URL | `https://baidumarketing.com/ja/blog/baidu-brand-protection-guide` |
...
### 5. 验证清单
完成后逐项确认：
- [ ] 文件输出到 `ja/blog/baidu-brand-protection-guide.html`
- [ ] `<html lang="ja">`
- [ ] canonical: `https://baidumarketing.com/ja/blog/baidu-brand-protection-guide`
